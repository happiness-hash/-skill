...
- 你希望得到的输出类型：OCR、总结、目录、模拟题、原题答案、模拟题答案
- 你希望走 CLI 还是 Web 模式
- 是否使用 OpenAI 兼容接口
...
```text
请用 exam-question-analysis skill 分析这个题目图片文件夹，先做 OCR，再输出全文总结、目录、模拟题和原题答案。
```
...
```text
请用 exam-question-analysis skill，使用 OpenAI 兼容接口做多模态 OCR，并生成模拟题答案总览和原题答案总览。
```
